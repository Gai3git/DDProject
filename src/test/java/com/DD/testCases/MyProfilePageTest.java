...
import com.DD.pageObjects.MyAccountOverviewPage;
import com.DD.pageObjects.MyProfilePage;
import com.DD.utilities.BaseClass;
import com.DD.utilities.ConstantsUtils;
import com.DD.utilities.ReadPropertiesUtils;
import com.DD.utilities.XLUtils;
...
public class MyProfilePageTest extends BaseClass
{
	...
	public void TC_LoginInfoblockPlaceHolderCheck() 
	{
		...
		softAssert.assertAll("PlaceHolders not displayed as expected for one or more fields in LOGIN INFORMATION block of My Profile page.");
		...
		if (validity.equals("Valid"))
		 ...
		 {	 	 
			 if (currPwd.equals("") || newPwd.equals("") || retypePwd.equals("") )
			 {
				 ...
				 softAssert.assertAll("Appropriate error messages are not displayed when current password or new password or retype password fields are empty");
	...
	public void TC_PersonalInfoblockTooltipCheck() throws InterruptedException 
	{
		...
		softAssert.assertAll("Tooltips not displayed as expected for one or more fields in PERSONAL INFORMATION block .");
	...
	public void TC_PersonalInfoblockPlaceHolderCheck() 
	{
		...
		softAssert.assertAll("PlaceHolders not displayed as expected for one or more fields in PERSONAL INFORMATION block of My Profile page.");
	...
	public void TC_PersonalInfoblockReqFieldError() throws InterruptedException 
	{
		...
		softAssert.assertAll("Appropriate error messages are not displayed as expected when First Name or Last Name or Primary Phone Number fields are empty");
	...
	public void TC_PersonalInfoUpdate(String fName,String lName,String PrimaryPh,String Ext,String SecondaryPh,String ExpPrimPhWithExt,String ExpSecondaryPh) throws InterruptedException 
	{
		...
		softAssert.assertAll("Personal Information Block field changes are not updated correctly.One or more fileds were not updated as expected in Account Overview Page / My Profile Page.TestCase failed");
